    ...
    render() {
        return (<div>
            ...
            <div className="container">
                ...
                <InputField type="select" options={["Student Loans","Car Loans","Appliance Loan"]}  Label="Loan Type" name="Loan Type"></InputField>
                ...
                <InputField Label="Duration of Loan" name="Duration of Loan"></InputField>
