    ...
    render() {
        return (<div>
            ...
            <div className="container col-offset-2 ">
                ...
                <InputField Label="Username" name="UserName" changed={this.handleChange}></InputField>
                <InputField Label="Password" name="Password" changed={this.handleChange}></InputField>
                ...
                <MyButton label="Log In" clicked={this.logIn}></MyButton>
