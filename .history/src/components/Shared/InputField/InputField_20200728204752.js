...
class InputField extends Component {
    static defaultProps = {
        ...
        options: [],
        validators:[()=>sconsole.log("Deafault validator running"),(event)=>console.log("Validator2")],
    }
    constructor(props) {
        super(props);
        this.state = {
    ...
    handleChange(event) {
        ...
        let error = this.props.validators.map(x=>console.log(x));
        // console.log(event.target.value)
        this.props.changes(Object.assign(event,error));
    }
    render() {
        return (
